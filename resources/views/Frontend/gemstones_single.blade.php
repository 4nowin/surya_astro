        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <ul class="breadcrumb">
                    ...
                    <li>//</li>
                    <li><a href="gemstones_single.html">gemstones single</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="ast_blog_box">
                    <div class="ast_blog_img">
                        ...
                        <img src="http://via.placeholder.com/848x409" alt="gemstones" title="Gemstones">
                    </div>
                    <div class="ast_blog_info">
                        ...
                        <h3 class="ast_blog_info_heading">Finibus non magna sed varius fusce risus eros.</h3>
