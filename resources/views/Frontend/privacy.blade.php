        ...
        <div class="row">
            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 col-lg-offset-1">
                <div class="ast_pp_section">
                    <h5 class="ast_toppadder10 ast_bottompadder10">General Terms of Use</h5>
                    ...
                    <h5 class="ast_toppadder10 ast_bottompadder10">When do we collect information?</h5>
                    <p>We collect information from you when you place an order or enter information on our site.</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">How do we use your information?</h5>
...
• To improve our website in order to serve you better serve.<br>
• To allow us to better service you in responding to your customer service requests</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10"> How do we protect visitor information?</h5>
                    <p>Our website is scanned on a regular basis for security holes and known vulnerabilities in order to make your visit to our site as safe as possible. </p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">DISCLOSURE</h5>
...
Your personal information is contained behind secured networks and is only accessible by a limited number of persons who have special access rights to such systems, and are required to keep the information confidential.<br>
...
All transactions are processed through a gateway provider and are not stored or processed on our servers.</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">Do we use ‘cookies’?</h5>
...
However, you can still place orders.</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">Third Party Disclosure</h5>
                    <p>We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information.</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">Third party links</h5>
                    <p>We do not include or offer third party products or services on our website.</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">Google</h5>
                    <p>We have not enabled Google AdSense on our site.<br>
Users will be notified of any privacy policy changes:<br>
• On our Privacy Policy Page</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">How does our site handle do not track signals?</h5>
                    ...
                    <h5 class="ast_toppadder10 ast_bottompadder10">Does our site allow third party behavioral tracking?</h5>
                    <p>It’s also important to note that we do not allow third party behavioral tracking.</p>
                    <h5 class="ast_toppadder10 ast_bottompadder10">Changes to this privacy policy</h5>
