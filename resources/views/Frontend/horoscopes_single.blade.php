            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="ast_blog_box">
                    <div class="ast_blog_img">
                        ...
                        <img src="http://via.placeholder.com/848x409" alt="horoscopes" title="Horoscopes">
                    </div>
                    <div class="ast_blog_info">
                        ...
                        <h3 class="ast_blog_info_heading">Sadipscing elitr, vero eos et accusam et justo.</h3>
