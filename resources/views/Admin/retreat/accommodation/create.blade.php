...
@section('content')
    ...
    <div class="mt-4">
        ...
        <form method="POST" action="{{ route('accommodation.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <x-selectize :options="$amenities" :multiple="true" name="amenities[]" ></x-selectize>
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-info">Save Accommodation</button>
            <a href="{{ route('accommodation.index') }}" class="btn btn-dark">Back</a>
        </form>
    </div>
@endsection
